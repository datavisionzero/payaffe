...
public sealed class ConfigurationExchangeRateSecretResolver(IConfiguration configuration)
    : IExchangeRateSecretResolver
{
    private const string ReferencePrefix = "configuration:";
    private const string AllowedConfigurationPrefix = "ExchangeRates:ProviderSecrets:";
